...
--
-- Host: localhost
-- Generation Time: Apr 15, 2016 at 05:08 PM
...
(5, 'Huỳnh Kim Trưởng Khoa Sản', '0963935710', '1987-04-15', 1, 'da nang', 'If you want to know more about a company, website, and a person, you’ll certainly go to their About page - which I always do. I love reading people''s about page especially those who are in the same industry as me. It''s always quite interesting to have a quick glimpse of who and what they are.', 1, 'While the About Page can be very informative, some websites go the extra mile and make their About page more than just a testimony of who they are...', 'fb.com', 1, 72);
...
(6, 'Post title 123', 'Returns a URL pointing to a combination of controller and action. If $url is empty, it returns the REQUEST\\_URI, otherwise it generates the URL for the controller and action combo. If full is true, the full base URL will be prepended to the result:', 123, 'Danana, VN', '2016-04-12', 1, 1, 1),
...
(16, 'Post title', 'Returns a URL pointing to a combination of controller and action. If $url is empty, it returns the REQUEST\\_URI, otherwise it generates the URL for the controller and action combo. If full is true, the full base URL will be prepended to the result:', 5000000, 'Danana, VN', '2016-01-07', 0, 2, 1),
...
(31, 'Test Post2', 'a', 500000000, 'Los Angeles, CA', '2009-07-09', 1, 29, 1),
...
(45, 'agadgadg', 'adgadg', 12, 'adgadg', '2016-03-25', 0, 1, 1),
(46, 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. ', 'abccccc', 123, 'da nang', '2016-03-31', 0, 4, 1),
...
(1, 'noname', '$2y$10$0CVCuU6tytIlw7va6qujm.a27X3VlmINAacazE/ymNlWaxpwkKK.O', 'thevien@outlook.com', '2016-03-16', 1, '123', 'user1-128x128', 2),
(2, 'test', '$2y$10$0CVCuU6tytIlw7va6qujm.a27X3VlmINAacazE/ymNlWaxpwkKK.O', 'kyler@gmail.com', '2016-03-22', 1, '123123', 'user2-128x128', 2),
(4, 'mark', '$2y$10$0CVCuU6tytIlw7va6qujm.a27X3VlmINAacazE/ymNlWaxpwkKK.O', 'mark@enclave.vn', '2016-03-28', 1, '1231', 'user6-128x128', 3),
(5, 'kyler', '$2y$10$0CVCuU6tytIlw7va6qujm.a27X3VlmINAacazE/ymNlWaxpwkKK.O', 'abc@abc.com', '2016-03-29', 1, '1313413r1', 'user8-128x128', 3);
